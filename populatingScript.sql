...
insert into mngr(empid, mngr_empid, name, salary, hoursperweek) values(19,19, 'Alastair Matthams',64753,39);
...
insert into mngr(empid, mngr_empid, name, salary, hoursperweek) values(54,54, 'Zackary Gillespie',61029,39);
